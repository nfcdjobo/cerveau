        ...
        .then(success=>{
            ...
            if(success.virement){
                ...
                success.virement.sort((a, b)=>new Date(b.created_at)-new Date(a.created_at)).forEach((vire, indice) => {
                    ...
                    const strong_accor_1_label = document.createElement("strong"); strong_accor_1_label.innerHTML=vire.beneficiaireNumber; label_accor.append(strong_accor_1_label); label_accor.innerHTML += " || ";

                    const strong_accor_2_label = document.createElement("strong"); strong_accor_2_label.innerHTML=vire.montant; label_accor.append(strong_accor_2_label); label_accor.innerHTML += " || ";

                    const strong_accor_3_label = document.createElement("strong"); strong_accor_3_label.innerHTML=vire.reference; label_accor.append(strong_accor_3_label); label_accor.innerHTML += " || ";
                    ...
                    const p_accor = document.createElement("p"); article_accor.append(p_accor); p_accor.innerHTML+="Vous avez effectué un virement de ";
                    const strong_accor_1_p = document.createElement("strong"); strong_accor_1_p.innerHTML=vire.montant+" FCFA"; p_accor.append(strong_accor_1_p); p_accor.innerHTML+= " au ";

                    const strong_accor_2_p = document.createElement("strong"); strong_accor_2_p.innerHTML=vire.beneficiaireNumber; p_accor.append(strong_accor_2_p); p_accor.innerHTML+= " compte de ";
